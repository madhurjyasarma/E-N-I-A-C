...
public class LockedMe {
    ...
    private static final String WELCOME_PROMPT =ANSI_GREEN+
            "\n*****************  "+ANSI_RED+"E*N*I*A*C"+ANSI_RESET+ANSI_GREEN+"  *******************"+ANSI_RESET + ANSI_GREEN +
                    "\n  ***************"+ANSI_RESET+ANSI_BLUE +"    V2.0 "+ANSI_GREEN+ "   *****************\n" + ANSI_RESET;
    ...
    void showPrimaryMenu() {
        ...
        try{
            ...
            switch (option){
                ...
                case 3 : {
                    System.out.println("This program is created and developed by" + ANSI_RED + " MVDZO" + ANSI_RESET);
